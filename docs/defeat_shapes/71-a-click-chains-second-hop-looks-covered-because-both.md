...
click → modal `.active`, closing [[77|shape 77]]) plus thorough pure-function unit tests for
...
**Why this is distinct from shape 77:** shape 77 is the zero-guard case — no click anywhere in
...
hop (shape 77) with `tests/diff_modal_wiring.test.mjs`. Round 2's judge corrupted: the row
