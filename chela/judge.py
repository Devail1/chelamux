...
def block_body(report: Report, pr_url: str | None, test_cmd: str) -> str:
    ...
    parts += [
        ...
        "awaiting_review.",
        "4. Check `docs/DEFEAT_SHAPES.md` (see `docs/defeat_shapes/` for the catalog itself) "
        "— if the shape above (what the guard asserted vs. what the mutation actually got "
